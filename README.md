...
Running the assembly function with input sizes 10, 100, 1000, and 10,000.
All tests used randomized input values, and the average execution time was calculated by looping each test 30 times.
